...
<head>
    ...
    <link href="assets/css/fontawesome.min.php">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-12">
                        <ul class="top-header-contact-info">
                            <li class="sg"><i class="fa fa-envelope"></i><a
                                    href="mailto:rudravedicyagyasansthan@gmail.com" class="d">
                                    rudravedicyagyasansthan@gmail.com</a></li>
                            <li class="sg"><i class="fa fa-phone"></i> <a href="tel:+91-7652041630" class="d">
                                    +91-7652041630</a></li>
                        </ul>
                    </div>
                </div>
