		...
		<div class="container-fluid">
				...
				<div class="col-md-6">
					<div class="services_matter">
						<h2 class="wow fadeInDown animated"><a href="javascript:void(0)">
								BIRTH REPORT </a></h2>
						<p class="wow fadeInDown animated">You can understand the details of your planets and their
			...
			<div class="row">
				<div class="services_matter">
					...
					<p>This is the main part of astrology so that you can understand the details of your planets and
